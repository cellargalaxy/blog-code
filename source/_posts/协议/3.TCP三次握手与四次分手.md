...
![](https://filebed.cellargalaxy.workers.dev/blog/code/20180318/www.centos.bz-wp-content-uploads-2012-08-100327002911.png.1.png)
2. 服务器收到报文要建立连接。seq=y，ack=x+1，SYN=1，ACK=1。服务器进入SYN_RECV状态。
![](https://filebed.cellargalaxy.workers.dev/blog/code/20180318/www.centos.bz-wp-content-uploads-2012-08-100327003054.png.1.png)
3. 客户端收到服务端的确认，进入ESTABLISHED状态。然后发送seq=x+1（SNY消耗一个序号），ack=y+1，ACK=1的报文
![](https://filebed.cellargalaxy.workers.dev/blog/code/20180318/www.centos.bz-wp-content-uploads-2012-08-100327003214.png.1.png)
4. 服务器收到之后，也进入ESTABLISHED状态，三次握手完成之后数据传输的报文ACK都为1。

# TCP四次分手
![](https://filebed.cellargalaxy.workers.dev/blog/code/20180318/upload-images.jianshu.io-upload_images-1641067-5ed8bf6c24244b4c.png.1.png)
