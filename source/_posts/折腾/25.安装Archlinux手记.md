...
sudo pacman -S sof-firmware alsa-firmware alsa-ucm-conf                       #一些可能需要的声音固件  #todo
...
vim ~/software/flameshot.sh
#!/bin/bash
/usr/bin/flameshot gui

#快捷键
/bin/bash /home/xxx/software/flameshot.sh
```
...
mkdir -p $HOME/document/software
mkdir -p $HOME/music
