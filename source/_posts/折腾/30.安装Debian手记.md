...
```shell
cd ~/.var/app/org.fcitx.Fcitx5/config/fcitx5
mv rime rime.back
...
```shell
vim ~/.var/app/org.fcitx.Fcitx5/config/fcitx5/rime/default.yaml
...
7. 启动软件，激活
8. 下载Consolas字体
9. 如果输入法框不跟踪光标：[JetBrainsRuntime-for-Linux-x64](https://github.com/RikudouPatrickstar/JetBrainsRuntime-for-Linux-x64)

### 卸载预装软件

如果按照了gnome的小游戏全家桶，进行卸载
