...
+ [ ] 下载安装镜像：https://www.debian.org/distrib/
    ...
    + 其次是Live Gnome，但是安装的是完整版gnome，会有有烦人的小游戏
...
手机里不好编辑文档，直接下载debian12的清华源配置，其余版本参考：https://mirrors.tuna.tsinghua.edu.cn/help/debian/
...
```shell
#隐藏grub菜单
#GRUB_TIMEOUT与GRUB_HIDDEN_TIMEOUT设置为0
#GRUB_HIDDEN_TIMEOUT_QUIET设置为true
...
#docker拉取镜像走代理，https://neucrack.com/p/286。可以先不配，前几个镜像慢点就慢点，等代理服务安装好了在配置
...
梯子，方便之后操作：http://127.0.0.1:2017/。提示，可以在手机里截图配置，通过USB到电脑里。
